      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="card mt-8 rounded-[1.75rem] p-6 shadow-xl shadow-brand-100/60 sm:p-8">
          ...
          <form onSubmit={submit} className="mt-7 space-y-4">
            <label className="block"><span className="mb-2 block text-sm font-semibold">이메일</span><div className="relative"><Mail size={17} className="absolute left-3.5 top-3.5 text-gray-400" /><input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} className={`${inputClass} pl-10`} placeholder="name@dimigo.hs.kr" /></div></label>
